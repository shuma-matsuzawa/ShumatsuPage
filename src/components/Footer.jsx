    ...
    <footer >
      <div class="container" className='contacts'>
            ...
            <a href="https://www.youtube.com/@shumatsu1123">
                <img src={YoutubeIcon} alt="YoutubeIcon" className="youtubeIcon" style={{width: '120px'}} />
            </a>
            </div>

            <div className="Icons" class="col-md-3">
            <a href="mailto:shumatsu.23@gmail.com ? subject=お問い合わせ&amp;body=メッセージ内容">
                <img src={GmailIcon} alt="GmailIcon" className="gmailIcon" style={{width: '120px'}} />
            </a>
            </div>

            <div className="Icons" class="col-md-3">
              <a href="https://github.com/shuma-matsuzawa">
                <img src={GithubIcon} alt="GithubIcon" className="githubIcon" style={{width: '120px'}} />
                </a>
            </div>
